...
var DracoDecoderModule = function (d) {
    ...
    function la() {
        ...
        E[la.buffer >> 2] = e;
        e = la.buffer;
        for (var d = 0; d < p.length; d++) if (p[d] && a.___cxa_can_catch(p[d], b, e)) return (e = E[e >> 2]), (c.adjusted = e), (sa(p[d]), e) | 0;
        e = E[e >> 2];
        return (sa(b), e) | 0;
    }
    function Z(e, c) {
    ...
    function wa(e) {
        function c() {
            if (!a.calledRun && ((a.calledRun = !0), !oa)) {
                ...
                if (a.postRun) for ("function" == typeof a.postRun && (a.postRun = [a.postRun]); a.postRun.length; ) Oa.unshift(a.postRun.shift());
                B(Oa);
            }
        }
        if (!(0 < ea)) {
            if (a.preRun) for ("function" == typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length; ) Pa.unshift(a.preRun.shift());
            B(Pa);
            0 < ea ||
                a.calledRun ||
                (a.setStatus
