...
export default class ThreeSpiralTimeline {
    constructor() {
        ...
        this.DOM = {
            timeline: ".js-3d-spiral-timeline",
            timelineSlider: ".js-3d-spiral-timeline-slider",
            timelineSliderWrapper: ".js-3d-spiral-timeline-slider-wrapper",
            timelineProgressLine: ".js-3d-spiral-timeline-pagination-progress-line",
    ...
    init() {
        ...
        const planeOverlayMaterial = new THREE.MeshBasicMaterial({
            color: 0x000000,
            transparent: true,
            opacity: 0,
            depthTest: false,
     ...
     * @param {THREE.Material} planeOverlayMaterial
     */
    createItem(
        i,
        timelineLoopItem,
        ...
        timelineItem.className = "c-3d-spiral-timeline-item swiper-slide";

        let timelineItemInner = document.createElement("div");
        timelineItemInner.className = "c-3d-spiral-timeline-item__inner";
        ...
        timelineItemInnerContent.className = "c-3d-spiral-timeline-item__inner-content";
        ...
        const planeOverlay = new THREE.Mesh(planeGeometryOverlay, planeOverlayMaterial.clone());
        planeOverlay.name = "black overlay";
        planeOverlay.position.z = 0.1;

        if (timelineLoopItem.darkOverlay) {
            planeOverlay.material.opacity = 0.2;
        } else {
            planeOverlay.material.opacity = 0;
        }
    ...
    swiperInit() {
        ...
        this.swiper = new Swiper(this.slider, {
            ...
            freeModeSticky: true,
            scrollbar: {
                el: ".js-3d-spiral-timeline-pagination-progress-wrapper",
                draggable: false,
            },
            breakpoints: {
                800: {
