...
},{"./ScrollMarquee":3,"gsap":"gsap","gsap/ScrollTrigger":"gsap/ScrollTrigger","three/examples/jsm/loaders/DRACOLoader":"three/examples/jsm/loaders/DRACOLoader"}],5:[function(require,module,exports){
"use strict";
...
var PanningGallery = /*#__PURE__*/function () {
  function PanningGallery() {
    _classCallCheck(this, PanningGallery);
  ...
  _createClass(PanningGallery, [{
    ...
    value: function init() {
      ...
      var panElementW = this.panningElement.clientWidth;
      var panElementH = this.panningElement.clientHeight;

      _gsap.gsap.set(this.panningElement, {
    ...
    key: "initMouseEnter",
    value: function initMouseEnter() {
      var _this2 = this;

      var _loop = function _loop(i, l) {
        _this2.panningItem[i].addEventListener("mouseenter", function (ev) {
          ev.preventDefault();

          _this2.changeTitleNumber(i + 1);

          _this2.changeTitle(ev.currentTarget);
        });
      };

      for (var i = 0, l = this.panningItem.length; i < l; i++) {
        _loop(i, l);
      }
    }
  }, {
    key: "initMouseLeave",
    value: function initMouseLeave() {}
  }, {
    key: "onMouseMove",
    value: function onMouseMove(ev) {
      ...
      var panElementW = this.panningElement.clientWidth;
      var panElementH = this.panningElement.clientHeight;
      var offsetX = window.innerWidth - panElementW;
      var offsetY = window.innerHeight - panElementH;

      _gsap.gsap.to(this.panningElement, {
        duration: 1,
    ...
    key: "changeTitleNumber",
    value: function changeTitleNumber(index) {
      this.titleNumberCurrent.textContent = this.zeroPad(index, 3);
    }
  }, {
    key: "changeTitle",
    value: function changeTitle(item) {
      this.titleCurrent.textContent = item.getAttribute("data-title");
      var titleSplit = new _SplitText.SplitText(this.titleCurrent);

      var titleSplitTimeline = _gsap.gsap.timeline();
...
var Studio = /*#__PURE__*/function () {
  ...
  _createClass(Studio, [{
    ...
    key: "studioHover",
    value: function studioHover() {
      _gsap.gsap.set(this.lettersAlt, {
        autoAlpha: 0
      });

      var studioTimeline = _gsap.gsap.timeline({
        paused: true
      });
      ...
      this.studio.addEventListener("mouseenter", function () {
...
},{"gsap/dist/gsap":2}],11:[function(require,module,exports){
"use strict";
...
var _Studio = _interopRequireDefault(require("./examples/studio/Studio"));
